...
def principal_feature_sample(npoint, inf, starting_index):
    '''
input:
    int32
    batch_size * ndataset * ndataset float32
    batch_size int32
returns:
    batch_size * npoint     int32
    '''
    return sampling_module.principal_feature_sample(inf, starting_index, npoint)
ops.NoGradient('PrincipalFeatureSample')
