...
def eval_one_epoch(sess, ops, num_votes=1, topk=1):
    ...
    print(total_time, total_batch_num, num_votes)
    print("avg.forward time: \t%f" % (total_time/total_batch_num/num_votes))


if __name__=='__main__':
    with tf.Graph().as_default():
        evaluate(num_votes=36)
    LOG_FOUT.close()
